...
environments:
  ...
  - Several packages offer functionality for turning R code into a web
    API:
      ...
      - The [RestRserve](https://cran.r-project.org/package=RestRserve) package is a
        R web API framework for building high-performance microservices
        and app backends based on
